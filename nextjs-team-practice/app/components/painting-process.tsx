...
const steps = [
  { 
    ...
    detail: "専門スタッフが現地へお伺いし、建物の状態を詳しく調査します。お客様のご要望をしっかりとヒアリングし、最適な施工方法と材料をご提案。その場で概算のお見積りをご提示いたします。"
  },
  { 
    id: 2, 
    title: "STEP2", 
    description: "お見積り提出・ご契約",
    detail: "現地調査の結果を基に、詳細なお見積りを作成。使用する塗料や施工方法、工期などについて詳しくご説明いたします。ご納得いただけましたら、正式なご契約となります。"
  },
  { 
    id: 3, 
    title: "STEP3", 
    description: "施工開始・完了",
    detail: "経験豊富な職人が、安全と品質を最優先に施工を行います。工程ごとに徹底した品質管理を実施し、完了後は細部まで点検。ご満足いただける仕上がりを保証いたします。"
  }
]
