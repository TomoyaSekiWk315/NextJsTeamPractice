      ...
      <div className="w-full bg-[#F3F3F3] rounded-[15px] sm:rounded-[25px] md:rounded-[50px] p-4 sm:p-8 md:p-16">
        ...
        <Card className="mb-4 sm:mb-6 md:mb-8 overflow-hidden hover:shadow-lg transition-shadow duration-300">
          <div className="flex flex-col sm:flex-row">
            ...
            <div className="relative p-4 sm:p-6 md:p-8 sm:w-1/2 bg-[#FFFFFF] flex flex-col">
              <div>
                <Link href={mainCard.link} className="block hover:text-[#005a64] transition-colors duration-300">
              ...
              <div className="mt-auto flex flex-wrap gap-4">
                <Link href={mainCard.link} className="w-full sm:w-auto">
                  <Button 
                    variant="outline"
            ...
            {/* タブレット以上では画像を右に配置 */}
            <Link href={mainCard.link} className="hidden sm:block sm:w-1/2 relative group">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          {cards.map((card, index) => (
            <Card 
              key={index} 
              className="group overflow-hidden hover:shadow-lg transition-all duration-300 sm:hover:-translate-y-1"
            >
